        ...
        let runSearch = function (keyword) {
            ...
            .then((data)=>{
                ...
                document.getElementById('searchobj').innerHTML = '<div id="main_container"><div id="img_container"><img src="https://image.tmdb.org/t/p/w200' + poster_path_p + '"></div><div id="text_container"><div class="test"><h1>' + title_p + '</h1></div>' + '<p id="overview">' + overview_p + '</p>' + '<p id="release_date">' + release_date_p +'</p></div></div>';
